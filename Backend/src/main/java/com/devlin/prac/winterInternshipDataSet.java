...
public class winterInternshipDataSet {
	...
	public winterInternshipDataSet(String business_code2, String cust_number2, String clear_date2, String buisness_year2, String doc_id2,
			String posting_date2, String document_create_date2, String due_in_date2, String invoice_currency2,
			String document_type2, String posting_id2, String total_open_amount2, String baseline_create_date2,
			String cust_payment_terms2, String invoice_id, String aging_bucket) {
		// TODO Auto-generated constructor stub
	}
	public winterInternshipDataSet() {
		// TODO Auto-generated constructor stub
	}
...
//		return "Hrdata [sl_no=" + sl_no + ", business_code=" + business_code + ", cust_number=" + cust_number + "]";
//	}
	@Override
	public String toString() {
		return "Hrdata [sl_no=" + sl_no + ", business_code=" + business_code + ", cust_number=" + cust_number
				...
				+ total_open_amount + ", baseline_create_date=" + baseline_create_date + ", cust_payment_terms=" + cust_payment_terms + ", invoice_id=" + invoice_id + ", aging_bucket=" + aging_bucket + "]";
	}
